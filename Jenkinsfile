        ...
        stage('Build Test Deploy') {
            ...
            stages{
                ...
                stage('Test') {
                    steps {
                        container('podman') {
                            sh 'podman run -it --rm --pull=never localhost/$IMAGE_NAME python -c "import scipy; import numpy; import pandas; import sklearn; import matplotlib; import seaborn; import fmriprep; import nilearn; import nipype; import nibabel; import fsleyes; import datalad; import hypertools; import networkx; import pynv; import bids"'
